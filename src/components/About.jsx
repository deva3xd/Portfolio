...
const About = () => {
    ...
    return (
        <div className="bg-custom-primary text-white max-w-screen-xl mx-auto px-5 lg:px-20 pt-14 relative border-t-2 border-white" id="about">
                ...
                <div className="flex mt-10">
                    ...
                    <div className="w-1/2">
                        ...
                        <div className="flex flex-wrap w-full uppercase justify-end text-sm sm:text-base">
                            <span className="rounded-lg bg-white font-bold text-custom-primary px-3 ms-1 mt-1">
                                Laravel
                            </span>
                            <span className="rounded-lg bg-white font-bold text-custom-primary px-3 ms-1 mt-1">
                                React
