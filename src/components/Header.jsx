        ...
        <section className="pt-36 max-w-screen-xl mx-auto px-5 sm:px-16" id="header">
            <div className="bg-primary rounded-xl h-80 flex px-8">
                ...
                <div className="w-full md:w-3/5 text-default flex flex-col justify-center">
                    ...
                    <p className="font-light text-xs lg:text-base">I live in Indonesia, has more than 2 years experience in building websites. I'm a responsible person, so the project I make will not exceed the specified tile limit.</p>
                </div>
            </div>
